...
// 1. Initialize GPIO port and pin as AF
   ...
   GPIO_ospeed(pinName, HIGH);                    // speed VHIGH=3      
...
// 2. Filter Duration (use default)
   ...
   TIMx->CCMR1 &=    ~(15<<4);               // clear IC1F
   TIMx->CCMR1 &=    ~(15<<12);              // clear IC2F
   TIMx->CCMR2 &=    ~(15<<4);               // clear IC3F
   TIMx->CCMR2 &=    ~(15<<12);              // clear IC4F
	 
   TIMx->CCMR1 |=    (2<<4);                 // set IC1F 0b0010
   TIMx->CCMR1 |=    (2<<12);                // set IC2F 0b0010
   TIMx->CCMR2 |=    (2<<4);                 // set IC3F 0b0010
   TIMx->CCMR2 |=    (2<<12);                // set IC4F 0b0010
